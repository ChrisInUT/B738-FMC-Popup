...
if PLANE_ICAO == "B738" then
	...
	function fmc_on_build(fmc_wnd, x, y)
		...
		-- 
		-- Strange behavior....
		page_label_large_cyan = read_dataref("laminar/B738/fmc1/Line00_C")
		page_label_large_green = read_dataref("laminar/B738/fmc1/Line00_G")
		page_label_large = read_dataref("laminar/B738/fmc1/Line00_L")
		page_label_small = read_dataref("laminar/B738/fmc1/Line00_S")
		label_line_1_small = read_dataref("laminar/B738/fmc1/Line01_X")
		label_line_1_large = read_dataref("laminar/B738/fmc1/Line01_LX")
		line_1_large_green = read_dataref("laminar/B738/fmc1/Line01_G")	
		line_1_large = read_dataref("laminar/B738/fmc1/Line01_L")
		line_1_small = read_dataref("laminar/B738/fmc1/Line01_S")
		label_line_2_small = read_dataref("laminar/B738/fmc1/Line02_X")
		line_2_large_green = read_dataref("laminar/B738/fmc1/Line02_G")
		line_2_large = read_dataref("laminar/B738/fmc1/Line02_L")
		line_2_small = read_dataref("laminar/B738/fmc1/Line02_S")
		label_line_3_small = read_dataref("laminar/B738/fmc1/Line03_X")
		line_3_large_green = read_dataref("laminar/B738/fmc1/Line03_G")
		line_3_large = read_dataref("laminar/B738/fmc1/Line03_L")
		line_3_small = read_dataref("laminar/B738/fmc1/Line03_S")
		label_line_4_small = read_dataref("laminar/B738/fmc1/Line04_X")
		line_4_large_green = read_dataref("laminar/B738/fmc1/Line04_G")
		line_4_large = read_dataref("laminar/B738/fmc1/Line04_L")
		line_4_small = read_dataref("laminar/B738/fmc1/Line04_S")
		label_line_5_small = read_dataref("laminar/B738/fmc1/Line05_X")
		line_5_large_green = read_dataref("laminar/B738/fmc1/Line05_G")
		line_5_large = read_dataref("laminar/B738/fmc1/Line05_L")
		line_5_small = read_dataref("laminar/B738/fmc1/Line05_S")
		label_line_6_small = read_dataref("laminar/B738/fmc1/Line06_X")
		label_line_6_large = read_dataref("laminar/B738/fmc1/Line06_LX")
		line_6_large_green = read_dataref("laminar/B738/fmc1/Line06_G")
		line_6_large = read_dataref("laminar/B738/fmc1/Line06_L")
		line_6_small = read_dataref("laminar/B738/fmc1/Line06_S")
		entry_line_large = read_dataref("laminar/B738/fmc1/Line_entry")
		
		-- Get indicator statuses
		exec_light = get("laminar/B738/indicators/fmc_exec_lights")
		fmc_call = get("laminar/B738/fmc/fmc_dspy")
		fmc_fail = get("laminar/B738/fmc/fmc_fail")
		fmc_msg = get("laminar/B738/fmc/fmc_message")
		fmc_offset = get("laminar/B738/fmc/fmc_offset")
	...
	function fmc_show_wnd()
		...
		float_wnd_set_title(fmc_wnd, "B738 FMC " .. fmc_version[0])
		float_wnd_set_imgui_builder(fmc_wnd, "fmc_on_build")
		-- float_wnd_set_onclose(fmc_wnd, "fmc_on_close")
	...
	function fmc_on_keystroke()
		if CKEY == "f" and OPTION_KEY == true and KEY_ACTION == "pressed" then
			toggle_fmc_display()
		end
	end
	
	-- function fmc_on_close()
		-- fmc_show_window = false
		-- fmc_hide_wnd()
	-- end
	-- add_macro("B738 FMC Popup (Show/Hide)", "toggle_fmc_display()", "toggle_fmc_display()", "deactivate")
